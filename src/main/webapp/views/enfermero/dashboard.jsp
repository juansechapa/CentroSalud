    ...
    <head>
        ...
        <style>
            ...
            .btn-dashboard:hover {
                ...
                background: linear-gradient(105deg, #2e8a00, #1f6b00);
                box-shadow: 0 6px 12px rgba(57, 169, 0, 0.3);
            }
            .footer-note {
                text-align: center;
                margin-top: 3rem;
        ...
        <div class="container mt-5">
            <div class="dashboard-header">
                ...
                <p class="mt-2">
                    ...
                    <fmt:message key="dashboard.enfermero.subtitulo"/>
                </p>
            </div>
            ...
            <div class="row justify-content-center g-4">
                <div class="col-md-5">
                    <div class="card-dashboard text-center p-4">
                        ...
                        <h3 class="card-title"><fmt:message key="nav.citas"/></h3>
                        <p class="card-text">
                            <fmt:message key="dashboard.enfermero.citas.desc"/>
                        </p>
                ...
                <div class="col-md-5">
                    <div class="card-dashboard text-center p-4">
                        ...
                        <h3 class="card-title"><fmt:message key="nav.pacientes"/></h3>
                        <p class="card-text">
                            <fmt:message key="dashboard.enfermero.pacientes.desc"/>
                        </p>
                        <a href="${pageContext.request.contextPath}/PacienteServlet?accion=listar" class="btn btn-dashboard text-white">
                            <i class="bi bi-eye me-2"></i> <fmt:message key="accion.ver.pacientes"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-note">
                <i class="bi bi-shield-check"></i> <fmt:message key="dashboard.enfermero.nota"/>
            </div>
        </div>
